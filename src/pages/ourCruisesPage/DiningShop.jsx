...
import styles from "./Dining.module.css"; // your styles
...
const DiningShop = () => {
  const categories = [
    { title: "Restaurant", img: RestaurantImg, link: "/dining#main-dining" },
    { title: "Cafe Shop", img: CafeImg, link: "/dining#Cafeshop" },
